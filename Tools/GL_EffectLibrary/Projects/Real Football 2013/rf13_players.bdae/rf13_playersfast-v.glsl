...
void main()
{
	...
	vec4 homogNormal = vec4(Normal,0.0);
    sphereUVs.x = dot(matViewI[0], homogNormal);
    sphereUVs.y = dot(matViewI[1], homogNormal);
    varTexCoord3.xy = (sphereUVs * vec2( 0.5,-0.5) + vec2( 0.5,0.5));
