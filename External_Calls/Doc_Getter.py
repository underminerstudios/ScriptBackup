...
class Import_the_Url_Data(object):
    ...
    def pull_the_info(self):
      ...
      url = 'https://docs.google.com/spreadsheets/d/1MMwCtwdc1C2LrWMkAb1LJMPys2i-qY8SbbJgdBAk6mQ/export?format=csv&id=1MMwCtwdc1C2LrWMkAb1LJMPys2i-qY8SbbJgdBAk6mQ&gid=0'
