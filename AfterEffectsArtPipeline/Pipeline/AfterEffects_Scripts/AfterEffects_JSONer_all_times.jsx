...
for (var i = 0; i <= mySelectedItems.length-1; i++){
    run_all(mySelectedItems[i]);
};

function run_all(compToUse){


var composition = compToUse
...
makeJSONfile (full_files, composition.name)
        ...
        json_file_name = object_name + "_parent" + '.json';
