...
def loadUI():
        ...
        UIFileName = os.path.join(UIFilePathLocation,"Producer_UI.ui")
        
        UIPythonFileName = os.path.join(UIFilePathLocation,"Producer_UI.py")
...
subprocess.call(os.path.join(os.path.dirname(__file__),'UI',"ProducerUI.py"),shell=True)
