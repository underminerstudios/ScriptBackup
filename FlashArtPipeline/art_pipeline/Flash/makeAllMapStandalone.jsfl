inputs = ["file:///C|/PRODBKLG/trunk/Bingo Blitz/Rooms/Lobby Map/background/BingoMap/bingo_map_1_v2.fla"]

//Do work on the files above.. you can put in mutiple files
